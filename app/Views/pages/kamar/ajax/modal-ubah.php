    ...
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            <div class="modal-header bg-success">
                <h4 class="modal-title"><i class="fa fa-plus-square"></i> &nbsp;Ubah Kamar</h4>
                <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                    <span aria-hidden="true">&times;</span>
                </button>
            </div>
            <?= form_open('/kamar/ubah', ['class' => 'form-ubah']); ?>
            <?= csrf_field(); ?>
            <div class="modal-body">
                <div class="row">
                    <input type="hidden" class="form-control" id="id_kamar" name="id_kamar" value="<?= $id; ?>">
                    ...
                    <div class="col-sm-12 col-md-4">
                        <div class="form-group">
                            ...
                            <select class="form-control" id="tipe_kamar" name="tipe_kamar" style="width: 100%;">
                                ...
                                <option value="VVIP" <?= $tipe == 'VVIP' ? 'selected' : ''; ?>>VVIP</option>
                                <option value="VIP" <?= $tipe == 'VIP' ? 'selected' : ''; ?>>VIP</option>
                                <option value="Kelas A" <?= $tipe == 'Kelas A' ? 'selected' : ''; ?>>Kelas A</option>
                                <option value="Kelas B" <?= $tipe == 'Kelas B' ? 'selected' : ''; ?>>Kelas B</option>
                                <option value="Kelas C" <?= $tipe == 'Kelas C' ? 'selected' : ''; ?>>Kelas C</option>
                            </select>
                    ...
                    <div class="col-sm-12 col-md-4">
                        <div class="form-group">
                            ...
                            <input type="number" class="form-control" id="jumlah_tempat_tidur" name="jumlah_tempat_tidur" value="<?= $jumlah; ?>">
